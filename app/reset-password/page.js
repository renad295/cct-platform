...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    // تحقق إن الإيميل موجود في Supabase
    ...
    // نستخدم admin API بدل كذا، نرسل مباشرة ونشوف الخطأ
      ...
      <div className="w-full max-w-md px-8 py-10 rounded-2xl shadow-lg border border-gray-100">
        ...
        {sent ? (
          <div className="text-center space-y-4">
            <div className="bg-green-50 text-green-700 text-sm px-4 py-4 rounded-xl text-left space-y-1">
              <p>✅ A reset link has been sent to:</p>
              <p className="font-semibold">{email}</p>
              <p className="text-xs text-green-600 mt-2">If you don't find the email, please check your <span className="font-semibold">Junk / Spam</span> folder.</p>
            </div>
